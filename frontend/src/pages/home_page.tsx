          ...
          <div className={`hero-slide absolute inset-0 flex items-center transition-opacity duration-1000 ${currentSlide === 0 ? 'opacity-100' : 'opacity-0 pointer-events-none'}`}>
            <div className="max-w-[1280px] mx-auto px-10 grid grid-cols-1 md:grid-cols-2 items-center gap-12 w-full">
              ...
              <div className="relative flex justify-center items-center group cursor-pointer">
                ...
                <img alt="Display professional stamps" className="relative z-10 w-[600px] lg:w-[700px] object-cover rounded-xl animate-float group-hover:scale-110 group-hover:rotate-2 transition-transform duration-700 drop-shadow-2xl shadow-xl" src="/hero_banner.png"/>
              </div>
            </div>
          </div>
          <div className={`hero-slide absolute inset-0 flex items-center transition-opacity duration-1000 ${currentSlide === 1 ? 'opacity-100' : 'opacity-0 pointer-events-none'}`}>
            <div className="max-w-[1280px] mx-auto px-10 grid grid-cols-1 md:grid-cols-2 items-center gap-12 w-full">
              ...
              <div className="relative group cursor-pointer mt-8 md:mt-0">
                ...
                <img alt="Online customization platform interface" className="relative z-10 w-full lg:w-[650px] h-[450px] lg:h-[550px] object-cover rounded-xl shadow-2xl border-8 border-white group-hover:scale-105 group-hover:shadow-vibrant-orange/30 transition-all duration-700" src="/hero_customize.png"/>
              </div>
            </div>
          </div>
        </div>
